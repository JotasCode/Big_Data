...
def from_csv_to_sql(csv_name, sql_name, table_name):
    try:
        ...
        print(f"✅ Los datos del archivo {csv_name} pasaron al archivo {sql_name} de forma exitosa.")
...
from_csv_to_sql('titanic.csv', '2_titanic.sql', 'tabla_pasajeros')